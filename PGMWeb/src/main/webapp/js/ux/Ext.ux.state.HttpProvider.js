 ...
 * </form>
 */
//Modified By Wei, add pageName and scopeObjectType
Ext.ns('Ext.ux.state');
...
Ext.extend(Ext.ux.state.HttpProvider, Ext.state.Provider, {
	...
	,submitState:function() {
		...
		params[this.paramNames.pageName] = this.pageName;
		params[this.paramNames.scopeObjectType] = this.scopeObjectType;
