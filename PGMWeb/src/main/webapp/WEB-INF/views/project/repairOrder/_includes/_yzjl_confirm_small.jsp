<div id="divGeneraDiv">
	<t:common type="text" tabindex='1090' path="actualAmount" id="actualAmount" key="Com.ActualAmount" notNull="${taskCode eq 'S000004'}" disabled="${taskCode ne 'S000004'}"/>
</div>
<div id="divAll">
	<t:common type="textarea" tabindex='10110' path="opinions11" id="opinions11" key="Com.Opinion" disabled="${taskCode ne 'S000004'}"/>
</div>
