...
<title>${winTitle}</title>
	...
	<jsp:directive.include file="/WEB-INF/views/project/repairOrder/_includes/_repairOrdersGrid.jsp" />
	<script type="text/javascript">
		function page_OnLoad() {
			...
			Ext.define('ERP.RepairOrdersAction' ,{
				extend : 'ERP.ListAction',
				launcherFuncName : "showRepairOrder"
			});
			PAction = new ERP.RepairOrdersAction({});
		}
	</script>
</head>
