...
if (CUtils.isTrueVal('${isHistory}')) {
	url = "/app/pgm/project/todotask/list/historyRepairSettleAccountJson";
} else {
	url = "/app/pgm/project/todotask/list/repairSettleAccountJson";
}
G_CONFIG = {
		url : url,
		root : 'data',
		...
		columns : [
           ...
           { id : 'entityCode', header : "${f:getText('Com.RepairCode')}", width : 180, editable : false,
        	   renderer : function (value, metaData, record) {
        		   return "<a href=\"javascript:showRepairSettleAccount('" + record.get('entityId') + "')\" style=\"text-decoration: none;\"> "+value+"</a>";
        	   }   
           },
