...
<title>${winTitle}</title>
	...
	<script type="text/javascript" src="/js/erp/project/projectApproveBudget/ProjectApproveBudgetAction.js"></script>
	<script type="text/javascript">
		<jsp:directive.include file="/WEB-INF/views/project/projectApproveBudget/_includes/_projectApproveBudget.js" />
	</script>
</head>
	
<body>
	<c:set var="bindModel" value="entity"/>       
	<form:form id="form1" action="/app/${APP_NAME}/project/projectApproveBudget/form/${entityId}/" method="post" modelAttribute="${bindModel}" enctype="multipart/form-data">
		<jsp:directive.include file="/WEB-INF/views/utils/_hiddenUtil.jsp" />
		<form:hidden path="version" id="version" />
		<div id="divWinHeader" class="divWinHeader">${winTitle}</div>
		<div id="divGeneral">
			<jsp:directive.include file="/WEB-INF/views/project/projectApproveBudget/_includes/_projectApproveBudgetGeneral.jsp" />
		</div>
	</form:form>
