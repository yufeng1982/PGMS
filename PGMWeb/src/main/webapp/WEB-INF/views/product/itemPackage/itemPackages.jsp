...
<c:set var="winTitle" value="${f:getText('FN.SetsOfLines')}"/>
	...
	<jsp:directive.include file="/WEB-INF/views/product/itemPackage/_includes/_itemPackagesGrid.jsp" />
	<script type="text/javascript">
		...
		function page_OnLoad() {
			...
			Ext.define('ERP.ItemPackageAction' ,{
				extend : 'ERP.ListAction',
				launcherFuncName : "showItemPackage",
			...
			PAction = new ERP.ItemPackageAction();
		}
	</script>
</head>
<body>
